...
import { GET_COURSE_DETAIL_SUCCESS, GET_COURSE_DETAIL_FAIL, DANG_KY_KHOA_HOC_THANH_CONG, DANG_KY_KHOA_HOC_THAT_BAI } from "./type";
...
export const actGetCourseDetail = (courseId) => {
    return dispatch => {
        quanLyKhoaHoc.layKhoaHoc(courseId)
            .then((res) => {
...
export const actDangKyKhoaHoc = (thongTinDangKy, token) => {
    ...
    return dispatch => {
        quanLyKhoaHoc.dangKyKhoaHoc(thongTinDangKy, token)
            .then(res => {
